...
using Task3___ReCaptcha.Providers;
using Task3___ReCaptcha.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            } else
            {
                ...
                if (!isCaptchaValid)
                {
                    ModelState.AddModelError("GoogleCaptcha", "Captcha not valid");
                    return BadRequest(ModelState);
                }
        ...
        private async Task<bool> IsCaptchaValid(string response)
        {
            try
            {
                var secret = "6Lf-rxEaAAAAANWkpqOp5BxDb6rbxWs1MKDwk4Ah";
